...
class Register extends React.Component {
    ...
    onSubmitSignIn = () => {
        fetch('https://ziyaad-smartbrain-api.herokuapp.com/register', {
            method:'post',
        ...
        <article className="br3 shadow-5 ba b--black-10 mv4 w-100 w-50-m w-25-l mw6 center">
            <main className="pa4 black-80">
                    <div className="measure">
                        ...
                        <div className="">
                            <input onClick={this.onSubmitSignIn} className="b br3 ph3 pv2 input-reset ba b--black bg-transparent grow pointer f6 dib" type="submit" value="Register" />
                        </div>
